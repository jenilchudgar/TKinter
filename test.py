...
back_btn_img = PhotoImage(file='img/player/back.png')
forward_btn_img =  PhotoImage(file='img/player/forward.png')
play_btn_img =  PhotoImage(file='img/player/play.png')
pause_btn_img =  PhotoImage(file='img/player/pause.png')
stop_btn_img =  PhotoImage(file='img/player/stop.png')
